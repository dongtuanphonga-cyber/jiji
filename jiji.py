...
════════════════════════════════════════════════  
         \n""","red", 0.0009)
    sleep(2)
    print(Colorate.Diagonal(Colors.red_to_green,"""1: vào tool spam sms""", ))
    print(Colorate.Diagonal(Colors.red_to_green,"""2: thoát tool """))
    chon = str(input (Colorate.Diagonal(Colors.red_to_green, '=> Nhập Số : ')))
    ...
    if chon == '1':
        if len(sys.argv) > 2:
            ...
            phone = input(Colorate.Horizontal(Colors.red_to_green, "Nhập số muốn tấn công: "))
            count = int(input(Colorate.Horizontal(Colors.red_to_green, "Số lần muốn tấn công: ")))
        for i in range(1, count + 1):
          run(phone, i)
        print(Colorate.Horizontal(Colors.red_to_green,"đã xong"))
        a = input(Colorate.Horizontal(Colors.red_to_green,"Nhấn enter để tiếp tục"))
    elif chon == '2':
        
        print(Colorate.Diagonal(Colors.red_to_green,"""Cảm ơn đã sử dụng tool"""))
        sys.exit()   
    else:
        print(Colorate.Diagonal(Colors.red_to_green,"nhập sai nhập lại"))
        n = input(Colorate.Diagonal(Colors.red_to_green,"nhấn enter để chọn lại: "))
